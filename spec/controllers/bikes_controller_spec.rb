...
RSpec.describe BikesController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      bike = Bike.create! valid_attributes
      get :show, params: {id: bike.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new bike" do
        ...
        expect(response.location).to eq(bike_url(Bike.last))
      end
    end
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the new bike" do
        ...
        post :create, params: {bike: invalid_attributes}, session: valid_session
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested bike" do
        bike = Bike.create! valid_attributes
        put :update, params: {id: bike.to_param, bike: new_attributes}, session: valid_session
        bike.reload
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the bike" do
        ...
        put :update, params: {id: bike.to_param, bike: invalid_attributes}, session: valid_session
        expect(response).to have_http_status(:unprocessable_entity)
        expect(response.content_type).to eq('application/json')
      end
    end
